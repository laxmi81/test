...
public class tc_08 extends page_load {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(1000);*/
				...
				WebElement dev_console=driver.findElement(By.xpath("//a[contains(text(),'Developer Console')]"));
				act.moveToElement(dev_console).build().perform();
				dev_console.click();
				Thread.sleep(3000);
				driver.quit();
